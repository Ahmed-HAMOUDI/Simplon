...
public class Main {
	...
	public static void ajouter () {
		System.out.println(" Ajouter les donner suivent2");
		System.out.println(" UserID");
		candid.setUserid(scan.nextInt());
	...
	public static void miss_jour() {
		...
		System.out.println(" Choisir UserID de candidat");
		candid.setUserid(scan.nextInt());
	...
	public static void main(String[] args) throws SQLException {
		...
		int choi;
		Candidat_Dao use = new Candidat_Dao();
